...
/**
 * UTF16 to UTF8 encoding converter implementation for performance
 * optimizations, supplementary characters are not supported. No string copy and
 * garbage memory is created by write methods, buffered stream wrapper should be
 * used for buffering
 *
 * @author jbaliuka
