...
import com.pds.p2p.core.jdbc.ar.ex.IllegalTypeException;
 ...
 */
public class ColumnMeta implements Cloneable, Serializable {
    /**
    ...
    public String getSimpleName() {
        return StringUtils.remove(_name, '_');
    }
    ...
    public void setTypeCode(int typeCode) {
        ...
        if (_type == null) {
            throw new IllegalTypeException("Unknown JDBC type code " + typeCode);
        }
        _typeCode = typeCode;
    }
    ...
    public void setType(String type) {
        ...
        if (typeCode == null) {
            throw new IllegalTypeException("Unknown JDBC type " + type);
        } else {
        ...
        if ((_defaultValue != null) && (_defaultValue.length() > 0)) {
            try {
                switch (_typeCode) {
                    ...
                    case Types.DATE:
                        return UtilType.convert(_defaultValue, Date.class);
                    case Types.TIME:
                        return Time.valueOf(_defaultValue);
                    case Types.TIMESTAMP:
                        return UtilType.convert(_defaultValue, Date.class);
                    case Types.BIT:
                        return UtilType.convert(_defaultValue, Boolean.class);
                    default:
                        if (Jdbc3Utils.supportsJava14JdbcTypes() && (_typeCode == Jdbc3Utils
    ...
    public Object clone() throws CloneNotSupportedException {
        ColumnMeta result = (ColumnMeta) super.clone();
        result._name = _name;
