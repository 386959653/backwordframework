...
public class Excel2003Reader implements HSSFListener {
    ...
    public Excel2003Reader(String fileName) {
        this.fileName = fileName;
    }

    public Excel2003Reader(String fileName, IExcelReader excelReader) {
        this.fileName = fileName;
        this.excelReader = excelReader;
    }
    ...
    public void process() throws IOException {
        ...
        try {
            ...
            if (sheetIndex > -1) {
                if (ignoreSheet == null || ignoreSheet != null && !ignoreSheet.equals(sheetName)) {
    ...
    public void processRecord(org.apache.poi.hssf.record.Record record) {
        ...
        switch (record.getSid()) {
            ...
            case BlankRecord.sid:
                ...
                thisStr = "";
                rowVals.put(ReadUtils.indexToColumn(thisColumn), thisStr);
                break;
            ...
            case LabelRecord.sid:
                ...
                rowVals.put(ReadUtils.indexToColumn(thisColumn), value);
                break;
            case LabelSSTRecord.sid: // 单元格为字符串类型
                ...
                if (sstRecord == null) {
                    rowVals.put(ReadUtils.indexToColumn(thisColumn), "");
                } else {
            ...
            case NumberRecord.sid: // 单元格为数字类型
                ...
                String col = ReadUtils.indexToColumn(thisColumn);
                value = String.valueOf(numrec.getValue());
                rowVals.put(col, value);
                // String fmtvalue = formatListener.getFormatString(numrec);
                // rowVals.put(col, value);
                // rowVals.put("$"+col, fmtvalue);
                break;
            default:
                break;
        }
        ...
        if (record instanceof LastCellOfRowDummyRecord) {
            ...
            if (ignoreSheet == null || !ignoreSheet.equals(sheetName)) {
