...
public abstract class TypeMap {
     ...
     */
    private static HashMap<String, Integer> _typeNameToTypeCode = Maps.newHashMap();
    /**
     * Maps {@link java.sql.Types} type code constants to the corresponding type names.
     */
    private static HashMap<Integer, String> _typeCodeToTypeName = Maps.newHashMap();
    /**
     * Conatins the types per category.
     */
    private static HashMap<JdbcTypeCategoryEnum, Set<Integer>> _typesPerCategory = Maps.newHashMap();
    ...
    protected static void registerJdbcType(int typeCode, String typeName, JdbcTypeCategoryEnum category) {
        ...
        if (typesInCategory == null) {
            typesInCategory = Sets.newHashSet();
