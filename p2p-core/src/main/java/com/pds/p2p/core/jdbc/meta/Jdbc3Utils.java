...
/**
 * Little helper class providing functions for dealing with the newer JDBC
 * functionality in a way that is safe to compile with Java 1.3.
 *
...
public abstract class Jdbc3Utils {
    ...
    public static boolean supportsJava14JdbcTypes() {
        try {
            return (Types.class.getField(TypeMap.BOOLEAN) != null) && (Types.class.getField(TypeMap.DATALINK) != null);
        } catch (Exception ex) {
            return false;
        }
    }
    ...
    public static boolean supportsJava14BatchResultCodes() {
        try {
            return (Statement.class.getField("SUCCESS_NO_INFO") != null) && (Statement.class.getField("EXECUTE_FAILED")
                                                                                     != null);
        } catch (Exception ex) {
            return false;
        }
     ...
     *
     * @param tableName  The name of the table that the batch update/insert was
     *                   performed on
