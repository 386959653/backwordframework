package com.pds.p2p.core.jdbc.ar.pool;
...
final class SingletonConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
        ...
        return new SingletonPreparedStatement(this,
                c.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
    }
